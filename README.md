...
lists all 137 skills with their trigger conditions and category groupings.
...
**137** skills across four categories. See [`docs/skills-index.md`](docs/skills-index.md) for the full index.
